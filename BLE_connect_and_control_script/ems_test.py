...
def play_rhythm(bluetooth, rhythm_substr, repeats, bpm, ems_flag, audio_flag, delay_val):
    actual_stim_length = 140 #ms
...
rhythm_substr = "1010101101011010"
repeats = 2
bpm = 120
ems_flag = 1
audio_flag = 1
...
play_rhythm(bluetooth, rhythm_substr, repeats, bpm, ems_flag, audio_flag, delay_val)
